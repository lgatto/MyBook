...
intro <- tryCatch(
    {
        description <- packageDescription("MyBook")
...
👉 [ghcr.io/lgatto/mybook](https://ghcr.io/lgatto/mybook) 🐳
...
#| eval: false
docker run -it ghcr.io/lgatto/mybook:devel R
```
...
#| eval: false
docker run -it ghcr.io/lgatto/mybook:devel bash
